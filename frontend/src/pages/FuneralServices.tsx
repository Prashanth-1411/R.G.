            ...
            {filteredServices.map((s, idx) => (
              ...
              >
                <div className="relative h-56 overflow-hidden bg-navy-100">
                  ...
                  <div className="absolute top-4 left-4 w-12 h-12 rounded-xl bg-navy-800 flex items-center justify-center shadow-lg transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3">
                    <Heart className="w-6 h-6 text-gold-400" />
                  </div>
                  <div className="absolute bottom-4 left-4 right-4">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm text-gold-300 text-[10px] font-bold uppercase tracking-wider border border-gold-500/20">
                ...
                <div className="p-6 sm:p-8 flex flex-col flex-grow">
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2 mt-5">
                    {s.features.slice(0, 3).map((f, i) => (
                      <span key={i} className="inline-flex items-center gap-1 px-3 py-1.5 bg-navy-50 text-navy-700 text-[10px] font-bold rounded-lg">
