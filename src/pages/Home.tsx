...
import {
  ...
  Star, ChevronRight, ArrowRight, Play, Quote,
...
import fleet8a from '../assets/funeral-1.jpg';
    ...
    <div className="pt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center py-20">
            ...
            >
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-white font-display leading-[1.05] tracking-tight">
                Emergency Ambulance
                <span className="block text-gradient"> & Funeral Services</span>
              </h1>
              ...
              <p className="text-lg text-navy-300 leading-relaxed max-w-xl font-body">
                ...
                Trust R.G. Ambulance Service for immediate clinical transfers and dignified funeral arrangements.
              </p>
              ...
              <div className="relative">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-black text-white font-display">8,200+</p>
                      <p className="text-xs text-navy-400">Patients Safely Transported</p>
                    </div>
                  </div>
                </motion.div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection direction="left">
              <div className="space-y-6">
                <SectionHeader
                  title="Why Healthcare Providers & Families Trust Us"
                  subtitle="In medical emergencies, every second counts. We maintain the highest standards of safety, clinical expertise, and response velocity."
                  align="left"
                />
      ...
      <section className="py-24 bg-navy-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <AnimatedSection>
            <SectionHeader
              title="Professional Emergency Services"
              subtitle="Equipped with certified medical gear and designed for safety, comfort, and absolute compliance."
            />
          </AnimatedSection>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
            {[
              { img: fleet1, title: 'ICU Ventilator Ambulance', desc: 'Full intensive care support with advanced monitoring rigs.' },
              { img: fleet2, title: 'Basic Life Support Rig', desc: 'Oxygen-equipped transport fleet for stable patient transfers.' },
              { img: fleet4, title: 'Neonatal NICU Ambulance', desc: 'Temperature-controlled portable incubator setups for newborns.' },
              { img: fleet8a, title: 'AC Funeral Hearse Van', desc: 'Dignified, air-conditioned vehicle for funeral processions.' },
            ].map((item, i) => (
              <AnimatedSection key={i} direction="up" delay={i * 0.1}>
                ...
                >
                  <div className="relative h-56 overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-4 group-hover:translate-y-0">
                      <motion.button
                        ...
                        className="w-full py-2.5 premium-gradient text-white font-bold rounded-lg text-xs shadow-glow flex items-center justify-center gap-1"
                      >
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-xs text-navy-400 mt-1 leading-normal">{item.desc}</p>
                  </div>
                </motion.div>
              </AnimatedSection>
            ))}
