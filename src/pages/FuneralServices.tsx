                ...
                <div className="p-6 sm:p-8 flex flex-col flex-grow">
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-auto pt-6">
                    ...
                    <motion.button
                      ...
                      className="py-3 text-center text-white bg-navy-800 hover:bg-navy-700 text-xs font-bold rounded-xl shadow-lg flex items-center justify-center gap-1.5 transition-all"
                    >
