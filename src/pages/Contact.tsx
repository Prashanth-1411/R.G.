          ...
          <div className="max-w-3xl py-20">
            ...
            >
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-white font-display leading-[1.05] tracking-tight">
                Contact Our
                <span className="block text-gradient"> Emergency Desk</span>
              </h1>

              <p className="text-lg text-navy-300 leading-relaxed max-w-xl font-body">
                Our medical coordinators are standing by 24/7. Call, WhatsApp, or send us an inquiry — 
                we respond within minutes during emergencies and within the hour for general inquiries.
              </p>
                ...
                {success ? (
                  ...
                  <form onSubmit={handleContactSubmit} className="space-y-5 font-body">
                    ...
                    <motion.button
                      ...
                      type="submit"
                      disabled={sending}
                      className="w-full py-4 premium-gradient text-white font-black rounded-xl text-sm shadow-glow flex items-center justify-center gap-2 disabled:opacity-60"
                    >
                      {sending ? (
                        <span>Sending...</span>
                      ) : (
                  ...
                  {contactInfo.map((info, i) => (
                    ...
                    >
                      <div className={`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 mt-0.5 ${
                        info.urgent ? 'bg-red-500/20' : 'bg-white/10'
                      }`}>
                        ...
                        {info.href ? (
                          <a
                            ...
                            className={`text-sm font-semibold hover:underline transition-all ${
                              info.urgent ? 'text-white text-base' : 'text-brand-300'
                            }`}
                          >
                            {info.value}
                          </a>
